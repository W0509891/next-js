                                ...
                                <li key={job.id} className="border border-gray-200 dark:border-gray-800 p-4 rounded-lg hover:shadow-md transition-shadow">
                                    <Link href={`/jobs/${job.id}`} className={`text-foreground flex justify-between items-center`}>
                                        ...
                                        <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                                            job.status === 'Applied' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300' :
                                                job.status === 'Interview' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300' :
                                                    job.status === 'Offer' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' :
